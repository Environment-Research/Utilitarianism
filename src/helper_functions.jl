...
function optimize_rice(optimization_algorithm::Symbol, n_opt_periods::Int64, stop_time::Int64, tolerance::Float64, backstop_prices::Array{Float64,2}; run_utilitarian::Bool=true, ρ::Float64=0.008, η::Float64=1.5, remove_negishi::Bool=true)
...
function fund_year_index(index_year::Int64)
...
function regional_mitigation(optimal_model::Model, end_year::Int64)
